...
<body class="easyui-layout" style="visibility:hidden;">
 ...
 <table cellpadding="0" cellspacing="0" style="width: 100%">
    <tr >
      <td>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" onclick="doChongFa('${pageContext.request.contextPath }/workbill/diaoDuBatch?ids=')">转单</a>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="doUpdate('${pageContext.request.contextPath}/workbill/findById?id=','${pageContext.request.contextPath }/workbill/updateStaffId')">手动转单</a>
     	<form id="formQuery"  class="easyui-linkbutton" data-options="plain:true" >
        <span style="margin-left: 30px">取派员工号 &nbsp;</span><input name="staff.id" type="text" class="easyui-textbox easyui-validatebox" style="width:100px" data-options="validType:'name'"> 
        </form>
