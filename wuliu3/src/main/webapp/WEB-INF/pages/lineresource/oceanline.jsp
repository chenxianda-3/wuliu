...
$(function() {
	...
	init("${pageContext.request.contextPath}/oceanline/findBypage");

	//onclickup插件的初始化，提供上传时候的用户交互
	$("#button-import").upload({
		action:'${pageContext.request.contextPath}/oceanline/importXls',
		name:'importFile',
		onSubmit:function () {
			var isImportUrl = "${pageContext.request.contextPath}/oceanline/isImport";
...
<body   style="visibility: hidden;" >
 ...
 <table cellpadding="0" cellspacing="0" style="width: 100%">
    <tr >
      <td>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="doAdd('${pageContext.request.contextPath }/oceanline/addOceanline')">新增</a>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="doUpdate('${pageContext.request.contextPath}/oceanline/findById?id=','${pageContext.request.contextPath }/oceanline/updateById')">修改</a>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" onclick="doDelete('${pageContext.request.contextPath }/oceanline/deleteBatch?ids=')">删除</a>
      ...
      <form id="formQuery"  class="easyui-linkbutton" data-options="plain:true" >
       <span style="margin-left: 10px">海运线路编码&nbsp;</span><input name="id" type="text" class="easyui-textbox" style="width:100px" > 
        <span style="margin-left: 30px">航线号 &nbsp;</span><input name="route" type="text" class="easyui-textbox " style="width:100px" > 
        </form>
...
<table id="grid"  >
	<thead>
		<tr>
			...
			<th field="id" data-options="width : 120,title : '海运线路编码',align : 'center',checkbox : false" ></th>
			<th field=route data-options="width : 120,title : '航线号',align : 'center'" ></th>
			...
			<th field="startport" data-options="width : 120,title : '起始港口',align : 'center'" ></th>
			...
			<th field="endport" data-options="width : 120,title : '到达港口',align : 'center'"  ></th>
