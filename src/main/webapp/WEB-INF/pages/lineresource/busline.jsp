...
$(function() {
	...
	init("${pageContext.request.contextPath}/busline/findBypage");

	//onclickup插件的初始化，提供上传时候的用户交互
	$("#button-import").upload({
		action:'${pageContext.request.contextPath}/busline/importXls',
		name:'importFile',
		onSubmit:function () {
			var isImportUrl = "${pageContext.request.contextPath}/busline/isImport";
...
<body   style="visibility: hidden;" >
 ...
 <table cellpadding="0" cellspacing="0" style="width: 100%">
    <tr >
      <td>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="doAdd('${pageContext.request.contextPath }/busline/addBusline')">新增</a>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="doUpdate('${pageContext.request.contextPath}/busline/findById?id=','${pageContext.request.contextPath }/busline/updateById')">修改</a>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" onclick="doDelete('${pageContext.request.contextPath }/busline/deleteBatch?ids=')">删除</a>
      ...
      <form id="formQuery"  class="easyui-linkbutton" data-options="plain:true" >
       <span style="margin-left: 10px">班车线路编号&nbsp;</span><input name="id" type="text" class="easyui-textbox easyui-numberbox" style="width:100px" data-options="validType:'length[0,32]',validType:'isBlank'"> 
        <span style="margin-left: 30px">班车线路名称 &nbsp;</span><input name="name" type="text" class="easyui-textbox easyui-validatebox" style="width:100px" data-options="validType:'name'"> 
        </form>
...
<table id="grid"  >
	<thead>
		<tr>
			...
			<th field="id" data-options="width : 120,title : '班车线路编码',align : 'center',checkbox : false" ></th>
			<th field="type" data-options="width : 120,title : '线路类型',align : 'center',formatter : function(data, row, index) {if (data == '0') {return '干线';} else if (data == '1') {return '省内';} else {return '市内';}}" ></th>
			...
			<th field="name" data-options="width : 120,title : '班车线路名称',align : 'center'" ></th>
			...
			<th field="startcity" data-options="width : 120,title : '发车城市',align : 'center'" ></th>
			...
			<th field="starttime" data-options="width : 120,title : '发车时间',align : 'center'" ></th>
			<th field="endtime" data-options="width : 120,title : '到达时间',align : 'center'"  ></th>
			...
			<th field="vol" data-options="width : 120,title : '承载体积',align : 'center'" ></th>
