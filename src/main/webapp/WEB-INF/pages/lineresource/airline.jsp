...
$(function() {
	...
	init("${pageContext.request.contextPath}/airline/findBypage");

	//onclickup插件的初始化，提供上传时候的用户交互
	$("#button-import").upload({
		action:'${pageContext.request.contextPath}/airline/importXls',
		name:'importFile',
		onSubmit:function () {
			var isImportUrl = "${pageContext.request.contextPath}/airline/isImport";
...
<body   style="visibility: hidden;" >
 ...
 <table cellpadding="0" cellspacing="0" style="width: 100%">
    <tr >
      <td>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="doAdd('${pageContext.request.contextPath }/airline/addAirline')">新增</a>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="doUpdate('${pageContext.request.contextPath}/airline/findById?id=','${pageContext.request.contextPath }/airline/updateById')">修改</a>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" onclick="doDelete('${pageContext.request.contextPath }/airline/deleteBatch?ids=')">删除</a>
      ...
      <form id="formQuery"  class="easyui-linkbutton" data-options="plain:true" >
       <span style="margin-left: 10px">航空线路编码&nbsp;</span><input name="id" type="text" class="easyui-textbox easyui-numberbox" style="width:100px" data-options="validType:'length[0,32]',validType:'isBlank'"> 
        <span style="margin-left: 30px">航班号 &nbsp;</span><input name="name" type="text" class="easyui-textbox easyui-validatebox" style="width:100px" data-options="validType:'name'"> 
        </form>
...
<table id="grid"  >
	<thead>
		<tr>
			...
			<th field="id" data-options="width : 120,title : '航空线路编码',align : 'center',checkbox : false" ></th>
			<th field="flightnum" data-options="width : 120,title : '航班号',align : 'center'" ></th>
			...
			<th field="startairport" data-options="width : 120,title : '起始机场',align : 'center'" ></th>
			...
			<th field="starttime" data-options="width : 120,title : '起飞时间',align : 'center'" ></th>
			<th field="endtime" data-options="width : 120,title : '落地时间',align : 'center'"  ></th>
			...
			<th field="endair" data-options="width : 120,title : '到达机场',align : 'center'"  ></th>
